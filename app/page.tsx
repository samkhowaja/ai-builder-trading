...
const initialModels: EntryModel[] = [
  {
    ...
    riskPerTrade: 1,
    description:
      "Fade the liquidity grabs around yesterday's high/low during London open using FVGs and displacement.",
    rules:
      "- Define HTF bias using H4 / H1.\n" +
                ...
                <div className="mt-3 grid gap-3 md:grid-cols-2">
                  <label className="block text-xs text-zinc-400">
                    ...
                    <textarea
                      ...
                      placeholder={"HTF bias confirmed?\nAsia low taken?\nFVG present?\nNews checked?"}
                    />
                  </label>
                  ...
                  <div className="max-h-64 overflow-auto rounded-md border border-zinc-800 bg-black/40 p-3 text-xs leading-relaxed text-zinc-100">
                    {coachText ? (
                      ...
                      <p className="text-[11px] text-zinc-500">
                        ...
                        <br />
                        • Suggestions to tighten rules
                        <br />
                        • Example trade scenarios with entry, SL &amp; TP
                      </p>
                    )}
                  </div>
                </div>
